...
<?php } else { ?>
                        <tr>
                            <td colspan="4" style="text-align: center;"><span style="background-color:#cccc00; padding: 10px; color:#ffffff; font-size:large;"><b>No hay programas registrados</b></span></td>
                        </tr>
<?php } ?>
                    </tbody>
